...
public class LocaterTypes_2 
{
 ...
 @Test
  public void Test_CSS_Tag_ID() throws Exception 
  {
	  System.out.println("Start finding Test_CSS_Tag_ID");
	  	 driver.get(baseUrl);
	    driver.findElement(By.cssSelector("input#lst-ib")).sendKeys("Selenium");
	    driver.findElement(By.cssSelector("button#_fZl")).click();
	    Thread.sleep(3000);
	    
	    System.out.println("Found elements be Test_CSS_Tag_ID");
  }
