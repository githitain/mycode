...
public class DC_Evalution_StepDef 
{
	...
	public  void EV_User_is_on_DC_Home_Page() throws Exception
	{
		System.out.println("Load DC_Evalution_StepDef Test-4");
	...
	public  void EV_User_is_logged_in_into_DC_and_currently_is_under_Evaluation_mode() throws Exception
	{
	...
	public  void EV_User_has_verified_that_Expenditure_Trends_subcategory_is_present_under_Acquisitions()
	{
	...
	public void EV_User_Expands_Expenditure_Trends_sub_category()
	{
	...
	public  void EV_Expenditure_Trends_subcategory_should_be_expandable_and_Following_reports_should_be_present()
	{
	...
	public void EV_User_Expands_Expenditure_Trends_sub_category_click_on_a_report()
	{
	...
	public  void EV_User_verify_the_Go_button()
	{
		cFuntion.waitThread(4000);
	...
	public  void EV_User_clicks_on_Go_button()
	{
		cFuntion.waitThread(4000);
	...
	public  void EV_User_verifies_the_Report_Expenditure_Trends_by_Bib_Level()
	{
		cFuntion.waitThread(4000);
	...
	public  void EV_User_clicks_on_signout_link()
	{
		cFuntion.waitThread(4000);
	...
	public  void EV_User_verifies_the_login_page()
	{
		cFuntion.waitThread(4000);
	...
	public void EV_User_close_browser_C60821()
	{
